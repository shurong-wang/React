	...
	render: function() {
		...
		for (var i = 0; i < content.blocks.length; i++) {
			...
			for (var i = 0; i < block.links.length; i++) {
				links.push(React.createElement("a", {onClick: this.handleClick, className: "card-link", href: "{block.links[i].url}"}, block.links[i].name))
			}
			blocks.push(React.createElement("div", {className: "card-block"}, 
		...
		for (var i = 0; i < content.listGroup.length; i++) {
			listGroup.push(React.createElement("li", {className: "list-group-item"}, 
				content.listGroup[i]
			))
		}
...
describe('Card component', function() {
	...
	beforeEach(function() {
		...
		card = TestUtils.renderIntoDocument(React.createElement(Card, {content: content, option: "center"}));
	});
...
},{"./Card.jsx":2,"jasmine-react-helpers":4,"react/addons":5}],4:[function(require,module,exports){
