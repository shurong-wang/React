    ...
    render: function() {
        return (
            React.createElement("label", null, 
                this.props.text, 
                React.createElement("input", {type: "checkbox", checked: this.props.checked, onChange: this.onChange}), 
...
var Survey = React.createClass({displayName: "Survey",
    ...
    render: function() {
        ...
        this.state.items.map(function (item, i) {
            labels.push(React.createElement(CheckboxWithLabel, {checked: that.state.status[i], index: i, text: item.text, on: item.on, off: item.off, onChange: that.onChange}))
        })
        return (
...
},{"./CheckboxWithLabel.jsx":2,"react/addons":5}],4:[function(require,module,exports){
...
describe("test Survey component", function () {
	it("mock CheckboxWithLabel component", function () {
		var survey = TestUtils.renderIntoDocument(React.createElement(Survey, null));
...
},{"./Survey.jsx":3,"jasmine-react-helpers":4,"react/addons":5}]},{},[178]);
